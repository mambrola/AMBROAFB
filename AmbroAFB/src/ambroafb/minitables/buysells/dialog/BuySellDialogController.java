...
public class BuySellDialogController implements Initializable {
    ...
    private BuySell buySell, buySellBackup;
    ...
    public void bindCurrency(BuySell buySell) {
        this.buySell = buySell;
        if (buySell != null){
            rec_id.textProperty().bindBidirectional(buySell.recIdProperty());
    ...
    public void setBackupCurrency(BuySell buySellBackup) {
