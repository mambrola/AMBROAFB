...
* (+) სიის ველებიანი stage-ები (მაგ. clients) როცა პირველ ჯერზე იხსნებოდნენ ანუ მათი ფილტრიცჩანდა და გაგვეთიშა არა დილტრის cancel-ით არამედ ამ სიის stage-ის წითელი x-ით, კოდი შედიოდა reAssignTable-ში რასაც აზრი არ ქონდა იმიტომ რომ მალე ისედაც გაითიშებოდა stage-ი. ამის თავიდან ასაცილებლად სიის stage-ის closeRequest-ის გადატვირთვის კოდს დავამატეთ რომ თუ ჩანს შესაბამისი ფილტრის ფანჯარა, მაშინ ამ ფანჯრის closeRequest-ი გამოიძახოს. რაც იწვევს იმას რომ filter-ის model ცარიელდება და reAssign-ის if staetement-ი აღარ სრულდება. ამიტომ აღარ შედის reAssignTable მეთოდში.ა
